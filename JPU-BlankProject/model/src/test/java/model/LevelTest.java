...
public class LevelTest {
    ...
    public void testGetDiamondsNumber() {
        test.setDiamondsNumber(5);
        assertEquals("The number of diamonds in the level must be 5", 5, test.getDiamondsCollected());
    }
    ...
    public void testGetPlayer() {
        assertSame("Should be the same",player,test.getPlayer());
